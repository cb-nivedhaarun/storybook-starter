<template>
 <div>
    <div class="border-b-2 py-2 mb-5">
      <h1 class="text-2xl	text-gray-700">Chargebee Payment Gateways - {{ variant }}</h1>
    </div>
...
export default {
  ...
  mounted() {
    ...
    let data = imageData.filter((item) => (item.category == "payment-gateway-logo" && item.variant === self.variant))
